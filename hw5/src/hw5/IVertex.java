...
public interface IVertex {
	 ...
	 * In order to visualize the map, you also need to keep track of its x and y
	 * coordinates on the map.
	 * 
	 * In order to calculate the shortest path between two vertices, you also need
	 * to keep track of:
	...
	/**
	 * Constructors:
	 * Constructor 1: This constructor should take only a String value as its
	 * parameter.
	 * In the constructor, initialize edge list, set x, y, total distance to 0;
	 * hasVisited to false
	 * 
	 * 
	 * Constructor 2: This constructor should take a String value, an x value and a
	 * y value as its parameter.
