...
public interface IGraph {
	 ...
	 * returns true if the graph contains any existing vertices that has the same
	 * value as the given vertex
	 * 
	 * @param v
	 * @return
	 */
	 ...
	 * Since List is a Collection, you need a concrete class when creating a list
	 * object.
	 ...
	 * If the graph already contains a vertex with the same value, throw an
	 ...
	 * and adds such edge between vertices that contain the starting value and
	 * destination value.
	 ...
	 * and adds a undirected edge between vertices that contain the starting value
	 * and destination value.
	 * This method constructs a undirected edge, which means start -> dest and dest
	 * -> start.
	 * 
	 * @param start
	 * @param dest
	 ...
	 * and returns the index of the vertex that has the least amount of total
	 * distance.
	 * 
	 * @param list
	 * @return
	 ...
	 * then reconstruct the path going from the vertex with the starting value to
	 * the vertex with the destination value.
	 * You may use any List type data structures (e.g., ArrayList, LinkedList, etc.)
	 * 
	 * @param start
	 * @param dest
	 ...
	 * ......
	 * 
	 * A is a vertex and (A - B)(A - C)(A - E) are all the edges between A and its
	 * neighbors.
	 */
